    ...
    <VisibilitySensor onChange={(isVisible)=>setElementIsVisible(isVisible)} minTopValue={300} >
      <div className="wrapper bg-[#081730] flex items-center justify-between px-[5rem] rounded-b-[5rem] w-[100%] h-[35rem] relative z-[3]">
        ...
        <div className="headings flex flex-col items-start justify-center h-[100%] text-[3rem]">
          ...
          <span><b>Best Qulaity Music</b></span>
          <span className="text-[15px] text-[#525D6E]">
            Donec laoreet nec velit vitae aliquam. Ut quis tincidunt purus.
            <br />
            Suspendisse in leo non risus timcidunt lobortis.
          </span>
          {/* download ads */}
          <div>
            <span className="text-[13px]">
              Download now on IQS and Android
            </span>
            <DownloadAds />
          </div>
        </div>
        ...
        <div className="images relative w-[50%]">
          ...
          <img src={require("../components/img/p 1.png")} alt=""
          ...
          <motion.img
            ...
            src={require("../components/img/p 2.png")}
            alt=""
          ...
          <motion.img
            ...
            src={require("../components/img/p 3.png")}
            alt=""
          ...
          <motion.img
            ...
            src={require("../components/img/p 4.png")}
            alt=""
